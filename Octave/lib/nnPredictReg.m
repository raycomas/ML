function y = nnPredictReg(weights, layer_sizes, X)
%nnPredictReg Make a regression prediction for the value of data points
%  nnPredictReg(weights, layer_sizes, X) 
%  Make a regression prediction for the value of data points using a neural network
%    weights      the weight vector obtained from nnTrainRegression
